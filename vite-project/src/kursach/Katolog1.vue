...
.fullscreen-image-modal .nav-button {
  position: absolute;
  padding: 12px;
  font-size: 28px; /* увеличенные стрелки */
  cursor: pointer;
  border-radius: 50%;
  z-index: 10000;
  background-color: rgba(128, 0, 128, 0.7); /* фиолетовый фон */
  color: white;
  transition: background-color 0.2s ease;
  border: none;
}
...
.fullscreen-image-modal .nav-button:hover {
  background-color: rgba(128, 0, 128, 1); /* насыщенный фиолетовый при наведении */
}
